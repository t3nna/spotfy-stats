...
import spotifyIcon from '../images/Spotify_Logo_RGB_White.png'
...
export default function Main() {
    ...
    return (
        <main className={'flow'}>
            <section className={'spotify-logo-guideline'}>
                <div className="container">
                    <a href="https://spotify.com" className="spotify-icon">
                        <svg viewBox="0 0 1134 340" ><title>Spotify</title>
